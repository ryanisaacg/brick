        ...
        if field_ty.move_semantics(&decls.id_to_decl).can_drop() {
            drop_variable(
                ...
                HirNode::autogenerated(
                    ...
                    ExpressionType::Pointer(PointerKind::UniqueRef, Box::new(field_ty.clone())),
                ),
                field_ty,
            );
        }
...
pub fn drop_variable(
    ...
    // Slot drops before any return statements to avoid them getting missed
    let insertion_idx = children
        .iter()
        .position(|child| {
            matches!(
                &child.value,
                HirNodeValue::Return(_) | HirNodeValue::Yield(_)
            )
        })
    ...
    match ty {
        ...
        ExpressionType::Collection(CollectionType::Array(_)) => {
            children.insert(
                insertion_idx,
                HirNode::new_void(HirNodeValue::IntrinsicCall(
        ...
        ExpressionType::Collection(CollectionType::ReferenceCounter(inner_ty)) => {
            ...
            drop_variable(
                ...
                HirNode::autogenerated(
                    ...
                    ExpressionType::Pointer(PointerKind::UniqueRef, inner_ty.clone()),
                ),
                inner_ty.as_ref(),
            );
            ...
            children.insert(
                insertion_idx,
                HirNode::new_void(HirNodeValue::If(
                    Box::new(HirNode::autogenerated(
        ...
        ExpressionType::InstanceOf(ty_id) => {
            ...
            }) = &decls.id_to_decl[ty_id]
            {
                if let Some(drop_fn_id) = associated_functions.get("drop") {
                    children.insert(
                        insertion_idx,
                        HirNode::new_void(HirNodeValue::Call {
                            func: Box::new(HirNode::autogenerated(
